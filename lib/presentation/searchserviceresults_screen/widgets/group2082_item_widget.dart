...
class Group2082ItemWidget extends StatelessWidget {
  Group2082ItemWidget(this.group2082ItemModelObj, {this.onTapGroup});

  Group2082ItemModel group2082ItemModelObj;

  var controller = Get.find<SearchserviceresultsController>();
