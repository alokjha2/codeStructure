import '../inboxdoctors_screen/widgets/group1535_item_widget.dart';
...
class InboxdoctorsScreen extends GetWidget<InboxdoctorsController> {
  @override
                                                                        ...
                                                                        children: [
                                                                          Padding(
                                                                              ...
                                                                              child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                                                                Padding(padding: EdgeInsets.only(left: getHorizontalSize(24.00)), child: Text("lbl_doctors_3".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AppStyle.textstylesfprotextsemibold132.copyWith(fontSize: getFontSize(13), height: 1.54))),
                                                                                GestureDetector(
                                                                                    onTap: () {
                                                                                      onTapTxtBotsupport();
                                                                                    },
                                                                                    child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(16.00), right: getHorizontalSize(24.00)), child: Text("lbl_bot_support".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AppStyle.textstylesfprotextsemibold133.copyWith(fontSize: getFontSize(13), height: 1.54))))
                                                                              ])),
                                                                          Padding(
                                                                ...
                                                                Align(
                                                                    alignment:
                                                                        Alignment
                                                                            .center,
                                                                    child: Padding(
                                                                        padding: EdgeInsets.only(left: getHorizontalSize(24.00), top: getVerticalSize(32.00), right: getHorizontalSize(24.00)),
                                                                        child: Obx(() => ListView.builder(
                                                                            physics: NeverScrollableScrollPhysics(),
                                                                            shrinkWrap: true,
                                                                            itemCount: controller.inboxdoctorsModelObj.value.group1535ItemList.length,
                                                                            itemBuilder: (context, index) {
                                                                              Group1535ItemModel model = controller.inboxdoctorsModelObj.value.group1535ItemList[index];
                                                                              return Group1535ItemWidget(model);
                                                                            }))))
                                                              ])))
                                                ])))))
                          ]))),
  ...
  onTapTxtBotsupport() {
    Get.toNamed(AppRoutes.inboxbotsupportScreen);
  }
}
