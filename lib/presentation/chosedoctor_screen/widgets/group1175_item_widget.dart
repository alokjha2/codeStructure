...
class Group1175ItemWidget extends StatelessWidget {
  Group1175ItemWidget(this.group1175ItemModelObj);

  Group1175ItemModel group1175ItemModelObj;

  var controller = Get.find<ChosedoctorController>();
