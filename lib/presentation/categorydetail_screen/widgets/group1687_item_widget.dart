...
class Group1687ItemWidget extends StatelessWidget {
  Group1687ItemWidget(this.group1687ItemModelObj);

  Group1687ItemModel group1687ItemModelObj;

  var controller = Get.find<CategorydetailController>();
