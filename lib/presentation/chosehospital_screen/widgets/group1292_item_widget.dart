...
class Group1292ItemWidget extends StatelessWidget {
  Group1292ItemWidget(this.group1292ItemModelObj);

  Group1292ItemModel group1292ItemModelObj;

  var controller = Get.find<ChosehospitalController>();
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  ...
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.right,
                                  style: AppStyle.textstylesfprotextregular144
                                      .copyWith(
                                    fontSize: getFontSize(
                                      14,
                                    ),
