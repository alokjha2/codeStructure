...
class Group3218ItemWidget extends StatelessWidget {
  Group3218ItemWidget(this.group3218ItemModelObj);

  Group3218ItemModel group3218ItemModelObj;

  var controller = Get.find<MyActivitydeliveryController>();
